...
// NovoRespositorioDePublicacoes cria um novo repositrio de publicacoes
func NovoRepositorioDePublicacoes(db *sql.DB) *Publicacoes {
	return &Publicacoes{db}
}

// Criar insere um publicacao no banco de dados
...
// Tras uma unica publicacao no banco
func (repositorio Publicacoes) BuscarPorID(publicacaoID uint64) (modelos.Publicacao, error) {
	// Join tabela publicacoes e usuarios
...
// Tras as publicacoes do usuario seguidos e do proprio usuario
