...
func (repositorio Usuarios) Buscar(nomeOuNick string) ([]modelos.Usuario, error) {
	...
	linhas, erro := repositorio.db.Query(
		"select id, nome, nick, email, createdOn from usuarios where nome LIKE ? or nick LIKE ?",
...
// Buscar por ID traz um usuários do banco de dados
func (repositorio Usuarios) BuscarPorID(ID uint64) (modelos.Usuario, error) {
	linhas, erro := repositorio.db.Query(
		"select id, nome, nick, email, createdOn from usuarios where id = ?",
		ID,
	)
...
// Deletar exclui as infos de um usario no banco de dados
...
// PararDeSeguir permite que um usuário para de seguir o outro
